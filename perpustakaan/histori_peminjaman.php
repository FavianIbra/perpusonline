    ...
    <tbody>
        ...
        while($data_histori=mysqli_fetch_array($qry_histori)){
            ...
            if(mysqli_num_rows($qry_cek_kembali)>0){
                ...
                $button_kembali="<a href='kembali.php?id=".$data_histori['id_peminjaman_buku']."' class='btn btn-warning' onclick='return confirm(\"apakah yang anda kembalikan benar?\")'>Kembalikan</a>";
            }
            ?>
            <tr>
                <td><?=$no?></td>
